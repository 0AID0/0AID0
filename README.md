...
- 🌐 **Frontend-разработка на JavaScript** — вёрстка, SPA, адаптивные интерфейсы, работа с DOM и Fetch API.
- ⚙️ **Backend на Node.js** — REST API, работа с БД.
- 🐍 **Python-скрипты** — автоматизация, парсинг, боты.
- 🔐 **Основы кибербезопасности** — шифрование, аутентификация, защита веб-приложений.
